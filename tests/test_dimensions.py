...
class TestDimPlayers:
            ...
            [
                {
                    ...
                    "current_club_id": 1,
                    "position": "RW",
                    "market_value_in_eur": 120_000_000,
            ...
            [
                {
                    ...
                    "current_club_id": 1,
                    "position": "GK",
                    "market_value_in_eur": 35_000_000,
    ...
    def test_uses_registry_tracked_columns(self, engine, players_source):
        ...
        _, stats = build_dim_players(
            bronze_players=bronze_v2,
            existing_dim=v1,
            players_source=players_source,
            batch_timestamp="2024-06-01",
            engine=engine,
        )
            ...
            [
                {
                    ...
                    "current_club_id": 1,
                    "position": "RW",
                    "market_value_in_eur": 150_000_000,
                    "country_of_citizenship": "England",
                },
            ]
        )
